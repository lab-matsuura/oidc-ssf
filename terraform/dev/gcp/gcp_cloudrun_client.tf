# Cloud Run Service - OIDC Client (RP)
resource "google_cloud_run_v2_service" "client" {
  name     = "ssf-oidc-client-${var.environment}"
  location = var.region
  ...
  template {
    ...
    containers {
      image = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.main.repository_id}/oidc-client:${var.image_tag}"
